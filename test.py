...
class Kiwoom(QAxWidget):
    ...
    def get_georaeryang(self, date, jongCode): #거래량 가져오기
        print('거래량')
        print(date, jongCode)
        self.dynamicCall("SetInputValue(String, String)","종목코드", str(jongCode))
        self.dynamicCall("SetInputValue(String, String)","기준일자", str(date))
